...
```{r}
library(ggplot2)
aves <- read.csv("/home/eeb177-student/Desktop/eeb-177/eeb-177-final-project/aves_ranges.csv", header = F, as.is = T)
...
aves_occ <- aves_occ + theme(axis.text.y = element_text(size=3))
aves_occ <- aves_occ + theme(axis.ticks.y = element_blank())
aves_occ <- aves_occ + scale_y_continuous(limits=c(0, 40), expand = c(0, 0), breaks=c(0, 10, 20, 30, 40))
